...
export const metadata: Metadata = {
  title: "Contact us — Scribl",
  description: "Get in touch with the Scribl team."
};
          ...
          <div className="wrap">
            ...
            <div className="contact-card">
              ...
              <p>
                ...
                <a href="mailto:hello@scribl.app">hello@scribl.app</a> and we&apos;ll get back to you as soon as we can.
              </p>
            </div>

            <div className="contact-card">
              <h3>Bug reports &amp; feature requests</h3>
              <p>Found something broken or have an idea to make Scribl better? Let us know — every message helps us improve.</p>
            </div>
